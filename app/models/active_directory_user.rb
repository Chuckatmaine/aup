...
class ActiveDirectoryUser
  ### BEGIN CONFIGURATION ###
  SERVER = 'uranus.kentshill.org'   # Active Directory server name or IP
  PORT = 389                    # Active Directory server port (default 389)
  BASE = 'DC=kentshill,DC=org'    # Base to search from
  DOMAIN = 'kentshill.org'        # For simplified user@domain format login
